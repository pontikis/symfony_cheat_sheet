...
* a **Route** which defines the URL in annotations with double asterisks /**
* a **Controller** the class which creates the "page" (returns a "Response" object)

### Hello world

This is the simplest Controller. It just prints 'Hello world!'.
